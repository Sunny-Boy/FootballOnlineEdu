   ...
   <div class="bgfff banner-box">
    ...
    <div class="submenu" v-if="state.current_menu==3">
     ...
     <div class="menuContent">
       <div class="item" style="background-color: black; font-size: 18px; text-align: center; " >
          <span class="title">公告消息</span>
       </div>


      <div class="item" :class="{'js-menu-item-on': state.current_menu==0}" @mouseover="state.current_menu=0" style="text-align: center;">
       <span class="title">本站推送</span>
       <i class="imv2-arrow1_r"></i>
      </div>

      <div class="item" :class="{'js-menu-item-on': state.current_menu==1}" @mouseover="state.current_menu=1"  style="text-align: center;">
       <span class="title">足球新闻</span>
       <i class="imv2-arrow1_r"></i>
      </div>
      <div class="item" :class="{'js-menu-item-on': state.current_menu==2}" @mouseover="state.current_menu=2"  style="text-align: center;">
       <span class="title">热门话题</span>
       <i class="imv2-arrow1_r"></i>
      </div>

      <div class="item" :class="{'js-menu-item-on': state.current_menu==3}" @mouseover="state.current_menu=3"  style="text-align: center;">
       <span class="title">热门比赛</span>
       <i class="imv2-arrow1_r"></i>
      </div>
      ...
      <div class="g-banner-content"  @mouseover="state.current_menu=-1">
        <el-carousel :interval="5000" arrow="always" height="530px" v-if="banner.banner_list[0]">
